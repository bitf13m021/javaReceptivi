...
public class Receptiviti {
    ...
    public Person GetPersonID(Person person) throws UnirestException, ReceptivitiExpection, JSONException {
    ...
    public Person SavePerson(Person person) throws UnirestException, ReceptivitiExpection, JSONException {
        String url = String.format("%s/v2/api/person", this.server);
        HttpResponse<JsonNode> response;
        String id = null;
    ...
    public Content AnalyseContent(Person person, Content content) throws UnirestException, ReceptivitiExpection, JSONException {
